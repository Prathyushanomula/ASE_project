...
public class UIHandler : MonoBehaviour {
  ...
  void GUIDisplayControls(){
    if (UIEnabled) {
      ...
      GUILayout.Label("Email:", GUILayout.Width(Screen.width * 0.50f));
      ...
      GUILayout.BeginHorizontal();
      GUILayout.Label("Password:", GUILayout.Width(Screen.width * 0.50f));
      ...
      GUILayout.BeginHorizontal();
      GUILayout.Label("Display Name:", GUILayout.Width(Screen.width * 0.50f));
      ...
      GUILayout.BeginHorizontal();
      GUILayout.Label("Phone Number:", GUILayout.Width(Screen.width * 0.50f));
      ...
      GUILayout.Space(20);
            /*
      GUILayout.BeginHorizontal();
      GUILayout.Label("Phone Auth Received Code:", GUILayout.Width(Screen.width * 0.50f));
  ...
  void OnGUI() {
    ...
    {
      // Portrait mode
      controlArea = new Rect(0.0f, 0.0f, Screen.width, Screen.height * 1.0f);
      logArea = new Rect(0.0f, Screen.height * 0.5f, Screen.width, Screen.height * 0.5f);
    }
    else
    {
      // Landscape mode
      controlArea = new Rect(0.0f, 0.0f, Screen.width * 1.0f, Screen.height);
