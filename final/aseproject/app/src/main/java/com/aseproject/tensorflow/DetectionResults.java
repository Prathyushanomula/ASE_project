...
try {
    final String url =
            "https://www.googleapis.com/youtube/v3/search?part=snippet&q=" +
                    URLEncoder.encode(wv1.getText().toString()+" news", "UTF-8") + "&type=video&key=AIzaSyAM8oBvEQUM3SIDy41ofXG-z6HgLeqyVFo";
    Toast.makeText(DetectionResults.this, " u " + url, Toast.LENGTH_SHORT).show();
    ...
    JsonObjectRequest jsonObjectRequest = new JsonObjectRequest
            (Request.Method.GET, url, null,
                                ...
                                lv1.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                                    ...
                                    public void onItemClick(AdapterView<?> adapter, View v, int position, long id) {
                                        ...
                                        try {
                                            ...
                                            Toast.makeText(DetectionResults.this, "v " + value, Toast.LENGTH_SHORT).show();
                ...
                public void onErrorResponse(VolleyError error) {
                    ...
                    Toast.makeText(
                            DetectionResults.this,
                            "e " + error, Toast.LENGTH_SHORT).show();
