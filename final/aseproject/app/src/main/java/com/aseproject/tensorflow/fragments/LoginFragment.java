package com.aseproject.tensorflow.fragments;
...
import com.mywebsite.arthree.activities.SocialLoginMainActivity;
import com.mywebsite.arthree.authentication.FirebaseUtils;



public class b vLoginFragment extends Fragment {
...
*/
    ...
    private void SignInWithEmail() {
        ...
        if(FirebaseUtils.isValidEmail(mEmail) && FirebaseUtils.isValidPassword(mPassword)){
            ...
            SocialLoginMainActivity.mAuth.signInWithEmailAndPassword(mEmail, mPassword)
